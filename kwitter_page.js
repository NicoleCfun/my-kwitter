...
function getData() {fierbace.database().ref("/"+room_name.on('value'.
function(snapshot) {document.getyElementById("output").innerHTML = "";
snapshot.forEach(function(childSnapshot) {childKey = childSnapshot.key;childData = 
childSnapshot.val();if(childKey != "pur[ose") { 
